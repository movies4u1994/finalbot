...
API_ID = int(environ.get('API_ID', '29761749')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'a18b40e995d5b74ec633a0cfdfa8e175')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "7833968452:AAG4Q4Y7EeApWjl9VlBIlijdlHLzuzjERzk")    # Bot token from @BotFather
...
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/bbopba.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/kk2ltl.jpg'))
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5685076977 1997617981').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002809601330').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003007009220'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003007009220'))  # Bin channel id (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002583639083')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002485029394')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movies4uhd123')  # Support group link (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/kk2ltl.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'Shelkeanant14@okicici')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Movies:Movies@cluster0.mvmjtpu.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Movies") # Database name (default: cluster)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies4uhd2') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Movies4uhd14') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/movies4uhd123') # Update channel link for the bot
